...
# Ensure project root is on sys.path so b4igo_email_agent is importable
    ...
    samples = [
        {
            ...
            "body": (
                "Dear Patient, Your recent blood test results are now "
        ...
        },
        {
            ...
            "body": (
                "Your official transcript for Fall 2024 semester is now "
