...
from b4igo_email_agent.ai_pipeline.app import (
...
class TestParseText(TestCase):
    ...
    def test_parse_text_returns_201_with_valid_text(self):
        with app.test_request_context(
            ...
            with patch("b4igo_email_agent.ai_pipeline.api._enqueue_entries"):
                _, status = parse_text()
    ...
    def test_parse_text_calls_pipeline_with_text(self):
        import b4igo_email_agent.ai_pipeline.app as api_module
        ...
        with app.test_request_context(
            ...
            with patch.object(api_module, "pipeline", spy), patch(
                "b4igo_email_agent.ai_pipeline.api._enqueue_entries"
            ):
                parse_text()
